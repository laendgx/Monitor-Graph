		...
		<browse>
			<preview>
				<icwrap ng-style='cmsInfo.cmsSizeDesc | wrapStyle'>
			        ...
			        <cwrap ng-style='cmsInfo.cmsSizeDesc | cmsStyle:textalign:cmsModel.family:cmsModel.size:cmsModel.color:cmsModel.icon' enterposi=-1 enterrow=1 enternew=false>
