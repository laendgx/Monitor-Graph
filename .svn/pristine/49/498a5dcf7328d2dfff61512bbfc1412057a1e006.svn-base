...
<div class='tplwrap'>
		...
		<browse>
			<preview>
				<icwrap ng-style='cmsInfo.cmsSizeDesc | wrapStyle'>
			        ...
			        <cwrap ng-style='cmsInfo.cmsSizeDesc | cmsStyle:textalign:cmsModel.family:cmsModel.size:cmsModel.color:cmsModel.icon:cmsInfo.cmsColor' enterposi=-1 enterrow=1 enternew=false>
	...
	<multitxta>
	    <btns inputs>
	        ...
	        <i class='textright'></i>
	        <i class='textcolor' ng-style='cmsModel.color | iColor:cmsInfo.cmsColor' ng-click='colors=!colors'>
